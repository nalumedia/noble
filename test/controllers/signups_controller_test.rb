...
class SignupsControllerTest < ActionController::TestCase
  ...
  test "should create signup" do
    assert_difference('Signup.count') do
      post :create, signup: { signup_email: @signup.signup_email, signup_name: @signup.signup_name, signup_phone: @signup.signup_phone, signup_status: @signup.signup_status }
    end
  ...
  test "should update signup" do
    patch :update, id: @signup, signup: { signup_email: @signup.signup_email, signup_name: @signup.signup_name, signup_phone: @signup.signup_phone, signup_status: @signup.signup_status }
    assert_redirected_to signup_path(assigns(:signup))
  end
